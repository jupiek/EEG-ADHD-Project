...
+ Include both alpha/theta
    ...
    data = as.data.frame(cbind(ID = data.change[,1], ADHD = data.change[,2], scale(data.change[,-c(1,2)])))
...
####Model fitting: Elastic Net (Lasso and Ridge Regression Combined)
    ...
    cvfit <- cv.glmnet(y=data$ADHD, x=as.matrix(data[, -c(1,2)]), family="binomial", alpha=0.7, type.measure = "class")
    cvfit$lambda.min
...
####Diagnostics
    ...
    ###WANHE & JAE'S CODE HERE
    ```
>>>>>>> 2658b82c0ea6be07db0b0d14a5e2514fb578d281
